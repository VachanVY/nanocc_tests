 ...
 * except that it calls a void function; make sure we restore stack frame
 * correctly after a void function call
 * */
...
int main(void) {
  // call lots_of_args many times; if we aren't deallocating arguments and
  // padding correctly, it will segfault
