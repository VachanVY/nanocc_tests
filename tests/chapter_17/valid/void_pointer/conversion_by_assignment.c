...
double* get_dbl_array(unsigned long n) { return (double*)malloc(n * sizeof(double)); }
...
int main(void) {
    ...
    *long_ptr_array[2] = 300l;
    ...
    /* one last test case: implicitly convert pointers to void * when we pass them to standard
     * library calls */
