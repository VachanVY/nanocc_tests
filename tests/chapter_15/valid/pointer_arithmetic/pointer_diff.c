...
int get_ptr_diff(int* ptr1, int* ptr2) { return (ptr2 - ptr1); }

/* subtract two pointers into array of longs */
int get_long_ptr_diff(long* ptr1, long* ptr2) { return (ptr2 - ptr1); }

/* subtract pointers to two elements in a multi-dimensional array */
int get_multidim_ptr_diff(double (*ptr1)[3][5], double (*ptr2)[3][5]) { return (ptr2 - ptr1); }

/* subtract pointers into a multi-dimensional array again, but at different levels of nesting */
int get_multidim_ptr_diff_2(double (*ptr1)[5], double (*ptr2)[5]) { return (ptr2 - ptr1); }
