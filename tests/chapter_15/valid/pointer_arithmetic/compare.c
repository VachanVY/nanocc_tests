/* Test comparison of elements of the same array, including multi-dimensional
 * arrays */
...
int main(void) {
  ...
  // we don't need to initialize this because we're only comparing pointers to
  // array elements, not dereferencing them
  unsigned long arr[5];
  ...
  // do the same for nested array elements. start w/ pointers to scalar elements
  // within array
