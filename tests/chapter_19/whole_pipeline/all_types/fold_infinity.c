...
double target_add_infinity(void) { return (1.0 / 0.0) + 1000e10; }

// subtracting a finite number from infinity results in infinity
double target_sub_infinity(void) { return (1.0 / 0.0) - 1000e10; }
...
double target_div_infinity_by_num(void) { return (1. / 0.) / 5.; }
