...
int target(void) {
  char c1 = 120;
  char c2 = 3;
  // if this weren't promoted, c1 + c1 would overflow, causing undefined
  // behavior if we had c1 + c1 wrap around to -16, this would result in -5 but
  // because we promote results to ints, this is 240 / 3, or 80
  char c3 = (c1 + c1) / c2;
