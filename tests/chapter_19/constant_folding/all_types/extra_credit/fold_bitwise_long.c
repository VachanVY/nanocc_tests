/* Test constant-folding the bitwise &, |, ^, >>, and << expressions with long
 * operands */
...
long target_shift_left(void) { return 1l << 62; }

long target_shift_right(void) { return 72057589742960640l >> 35; }
