...
int main(void) {
  int dead_int_cast =
      0 ? (int)2147483649.0 : 100; // in the range of uint but not int
  unsigned int dead_uint_cast = 0 ? (unsigned int)34359738368.0
                                  : 200; // in the range of long but not uint
  signed long dead_long_cast =
      1 ? 300
        : 9223372036854777856.0; // in the range of unsigned long but not long
