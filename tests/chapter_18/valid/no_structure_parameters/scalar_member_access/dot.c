...
// parameters
int accept_params(int d_divided, int c_doubled, double l_cast, int dereferenced_ptr, double d,
                  int c, long l, char* ptr) {
    if (d != 4e12 || c != 127 || l != 8589934594l || *ptr != 100 || d_divided != 100.0 ||
        c_doubled != 254 || l_cast != 8589934594.0 || dereferenced_ptr != 100) {
        return 0;
    }
...
int test_auto(void) {
    ...
    // read all members
    if (autom.d != 4e12 || autom.c != 127 || autom.l != 8589934594l || autom.ptr != &chr) {
        return 0;
    }
    ...
    if (!accept_params(autom.d / 4e10, autom.c * 2, (double)autom.l, *autom.ptr, autom.d, autom.c,
                       autom.l, autom.ptr)) {
        return 0;
    }
...
int test_static(void) {
    ...
    // read all members
    if (stat.d != 4e12 || stat.c != 127 || stat.l != 8589934594l || stat.ptr != &chr) {
        return 0;
    }
    ...
    // read members and use them in complex expressions (e.g. function calls)
    if (!accept_params(stat.d / 4e10, stat.c * 2, (double)stat.l, *stat.ptr, stat.d, stat.c, stat.l,
                       stat.ptr)) {
        return 0;
    }
