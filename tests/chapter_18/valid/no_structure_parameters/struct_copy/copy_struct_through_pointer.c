...
int test_copy_to_array_elem(void) {
    ...
    // validate
    if (strcmp(arr[1].arr, "\n\t") || arr[1].inner.a != 10000 || arr[1].inner.b != 20000) {
        return 0;
    }
...
int test_copy_from_array_elem(void) {
    struct s arr[3] = {{"ab", {-3000, -4000}}, {"cd", {-5000, -6000}}, {"ef", {-7000, -8000}}};
...
int test_copy_to_and_from_array_elem(void) {
    ...
    // element 0
    if (strcmp(arr[0].arr, "ef") || arr[0].inner.a != -7000 || arr[0].inner.b != -8000) {
        return 0;
    }

    // element 1
    if (strcmp(arr[1].arr, "cd") || arr[1].inner.a != -5000 || arr[1].inner.b != -6000) {
        return 0;
    }

    // element 2
    if (strcmp(arr[2].arr, "ef") || arr[2].inner.a != -7000 || arr[2].inner.b != -8000) {
        return 0;
    }
...
int test_copy_array_element_with_padding(void) {
    ...
    arr[1] = elem;
    if (arr[0].a != 0 || arr[0].b != 1 || arr[0].c != 2 || arr[1].a != 9 || arr[1].b != 9 ||
        arr[1].c != 9 || arr[2].a != 6 || arr[2].b != 7 || arr[2].c != 8) {
        return 0;
    }
