...
int main(void) {
    ...
    if (o.in_array[0].a != 150. || o.in_array[0].b != 40 || o.in_array[0].ptr != &i) {
        return 13; // fail
    }

    if (o.in_array[1].a != 80e20 || o.in_array[1].b != 120 || o.in_array[1].ptr) {
        return 14; // fail
    }
    ...
    if (o.in_array[3].a != 1 || o.in_array[3].b != 1 || o.in_array[3].ptr != &i2) {
        return 16; // fail
    }
