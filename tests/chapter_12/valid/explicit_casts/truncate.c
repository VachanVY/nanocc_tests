...
int main(void) {
  ...
  /* -9223372036854774574 (i.e. -2^63 + 1234) is outside the range of unsigned
   * int, so add 2^32 to bring it within range */
  ...
  /* 4294967200 (i.e. 2^32 - 96) can be cast to an unsigned int without changing
   * its value, but must be reduced modulo 2^32 to cast to a signed int
   */
