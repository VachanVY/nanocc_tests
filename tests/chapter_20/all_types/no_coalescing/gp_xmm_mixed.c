...
int target(int one, int two, double one_d, double two_d, int three,
  ...
  check_14_doubles(ten_d, eleven_d, twelve_d, thirteen_d, fourteen_d, fifteen_d,
                   sixteen_d, seventeen_d, eighteen_d, nineteen_d, twenty_d,
                   twenty_one_d, twenty_two_d, twenty_three_d, 10.0);
